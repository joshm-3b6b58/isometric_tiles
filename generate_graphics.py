...
def create_square_border_array(size, border_width=1, border_color=(255, 255, 255, 255), default_value=(0, 0, 0, 0)) -> np.ndarray:
...
iso_img = Image.fromarray(convert_to_isometric(create_square_border_array(32, border_width=2, border_color=outline_color)))
rot_iso_img = iso_img.rotate(90, expand=True)
rot_iso_img.save('assets/grid_cell.png')

iso_img = Image.fromarray(convert_to_isometric(create_square_border_array(32, border_width=3, border_color=selected_outline_color)))
rot_iso_img = iso_img.rotate(90, expand=True)
rot_iso_img.save('assets/selected_grid_cell.png')

iso_img = Image.fromarray(convert_to_isometric(create_square_border_array(64, border_width=2, border_color=overlay_outline_color, default_value=selected_fill_color)))
rot_iso_img = iso_img.rotate(90, expand=True)
